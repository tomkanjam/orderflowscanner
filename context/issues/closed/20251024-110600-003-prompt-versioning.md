...
1. PromptLoaderV2 updated with version parameter support
2. Operations config has promptVersion fields for all operations
3. All operation handlers pass version to loader
4. Version logged in Braintrust traces via metadata
5. Version included in Braintrust REST API calls
