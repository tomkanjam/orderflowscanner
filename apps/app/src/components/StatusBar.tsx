      ...
      <div className="flex items-center justify-between h-full text-xs">
        ...
        <div className="flex items-center gap-2">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[var(--nt-accent-lime)]">
            <path d="M15 12L20 12" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
            <path d="M4 5L10 11" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
            <path d="M10 13L4 19" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
          </svg>
