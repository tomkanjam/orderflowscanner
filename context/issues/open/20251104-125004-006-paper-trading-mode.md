...
Implement simulated trading mode that executes all logic without real orders. Essential for testing and allowing users to validate strategies risk-free.

**Benefits:**
- Test entire system without risk
- Users can validate strategies before real money
...
- Depends on: `context/issues/open/20251104-125004-003-order-execution-engine.md`
...
**Integration tests:**
- Full workflow: signal → paper position → paper close
