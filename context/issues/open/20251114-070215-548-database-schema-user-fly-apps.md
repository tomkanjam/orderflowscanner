# Database Schema for User Fly Apps
...
Need database tables to track Fly app provisioning, status, and lifecycle for each Pro/Elite user.
...
### Event Log Table: `user_fly_app_events`
...
Update existing trigger to check for Fly app requirement:

```sql
-- Function to auto-provision/deprovision Fly app on tier changes
...
Create: `supabase/migrations/XXX_create_user_fly_apps_tables.sql`

All SQL above should go into this migration file.
